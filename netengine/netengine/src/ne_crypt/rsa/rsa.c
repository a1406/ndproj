...
#include "ne_crypt/rsah/nn.h"

static NEINT32 RSAPublicBlock PROTO_LIST 
  ((NEUINT8 *, NEUINT32 *, NEUINT8 *, NEUINT32,
    R_RSA_PUBLIC_KEY *));
static NEINT32 RSAPrivateBlock PROTO_LIST 
  ((NEUINT8 *, NEUINT32 *, NEUINT8 *, NEUINT32,
    R_RSA_PRIVATE_KEY *));

/* RSA public-key encryption, according to PKCS #1.
 */
NEINT32 RSAPublicEncrypt
  (output, outputLen, input, inputLen, publicKey, randomStruct)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
R_RSA_PUBLIC_KEY *publicKey;                              /* RSA public key */
R_RANDOM_STRUCT *randomStruct;                          /* random structure */
{
  NEINT32 status;
  NEUINT8 byte, pkcsBlock[MAX_RSA_MODULUS_LEN];
  NEUINT32 i, modulusLen;
 ...
 */
NEINT32 RSAPublicDecrypt (output, outputLen, input, inputLen, publicKey)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
...
{
  NEINT32 status;
  NEUINT8 pkcsBlock[MAX_RSA_MODULUS_LEN];
  NEUINT32 i, modulusLen, pkcsBlockLen;
 ...
 */
NEINT32 RSAPrivateEncrypt (output, outputLen, input, inputLen, privateKey)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
 ...
 */
NEINT32 RSAPrivateDecrypt (output, outputLen, input, inputLen, privateKey)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
 ...
 */
static NEINT32 RSAPublicBlock (output, outputLen, input, inputLen, publicKey)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
...
/* Raw RSA private-key operation. Output has same length as modulus.
   ...
   Requires input < modulus.
 */
static NEINT32 RSAPrivateBlock (output, outputLen, input, inputLen, privateKey)
NEUINT8 *output;                                      /* output block */
NEUINT32 *outputLen;                          /* length of output block */
NEUINT8 *input;                                        /* input block */
NEUINT32 inputLen;                             /* length of input block */
R_RSA_PRIVATE_KEY *privateKey;                           /* RSA private key */
{
  ...
  NEUINT32 cDigits, nDigits, pDigits;
