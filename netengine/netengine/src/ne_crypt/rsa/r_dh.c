...
#include "ne_crypt/rsah/prime.h"

/* Generates Diffie-Hellman parameters.
 */
NEINT32 R_GenerateDHParams (params, primeBits, subPrimeBits, randomStruct)
R_DH_PARAMS *params;                       /* new Diffie-Hellman parameters */
NEUINT32 primeBits;                          /* length of prime in bits */
NEUINT32 subPrimeBits;                    /* length of subprime in bits */
...
/* Sets up Diffie-Hellman key agreement. Public value has same length
   as prime.
 */
NEINT32 R_SetupDHAgreement
  (publicValue, privateValue, privateValueLen, params, randomStruct)
NEUINT8 *publicValue;                             /* new public value */
NEUINT8 *privateValue;                           /* new private value */
NEUINT32 privateValueLen;                    /* length of private value */
 ...
 */
NEINT32 R_ComputeDHAgreedKey
  (agreedKey, otherPublicValue, privateValue, privateValueLen, params)
NEUINT8 *agreedKey;                                 /* new agreed key */
NEUINT8 *otherPublicValue;                    /* other's public value */
NEUINT8 *privateValue;                               /* private value */
NEUINT32 privateValueLen;                    /* length of private value */
R_DH_PARAMS *params;                           /* Diffie-Hellman parameters */
{
