...
static void EncodeQuantum PROTO_LIST ((NEUINT8 [4], NEUINT8 [3]));
static NEINT32 DecodeQuantum PROTO_LIST ((NEUINT8 [3], NEUINT8 [4]));
static void EncodeLastQuantum
  PROTO_LIST ((NEUINT8 [4], NEUINT8 *, NEUINT32));
static NEINT32 DecodeLastQuantum
  PROTO_LIST ((NEUINT8 *, NEUINT32 *, NEUINT8 [4]));

/* This always returns 0.  It is an NEINT32 function for future compatibility.
 */
NEINT32 R_EncodePEMBlock (encodedBlock, encodedBlockLen, block, blockLen)
NEUINT8 *encodedBlock;                               /* encoded block */
NEUINT32 *encodedBlockLen;                   /* length of encoded block */
NEUINT8 *block;                                              /* block */
...
NEINT32 R_DecodePEMBlock (block, blockLen, encodedBlock, encodedBlockLen)
NEUINT8 *block;                                              /* block */
NEUINT32 *blockLen;                                  /* length of block */
NEUINT8 *encodedBlock;                               /* encoded block */
NEUINT32 encodedBlockLen;                    /* length of encoded block */
...
NEUINT8 quantum[3];
{
  ...
  a = (NEUINT32)((temp >> 18) & 0x3f);
  b = (NEUINT32)((temp >> 12) & 0x3f);
  c = (NEUINT32)((temp >> 6) & 0x3f);
  d = (NEUINT32)(temp & 0x3f);
...
static NEINT32 DecodeQuantum (quantum, encodedQuantum)
NEUINT8 quantum[3];
NEUINT8 encodedQuantum[4];
{
  UINT4 temp;
  ...
  quantum[0] = (NEUINT8)(temp >> 16);
  quantum[1] = (NEUINT8)(temp >> 8);
  quantum[2] = (NEUINT8)temp;
...
static NEINT32 DecodeLastQuantum (quantum, quantumLen, encodedQuantum)
NEUINT8 *quantum;
NEUINT32 *quantumLen;                                      /* 1, 2 or 3 */
NEUINT8 encodedQuantum[4];
{
