...
static NEINT32 RSAFilter PROTO_LIST
  ((NN_DIGIT *, NEUINT32, NN_DIGIT *, NEUINT32));
static NEINT32 RelativelyPrime PROTO_LIST
  ((NN_DIGIT *, NEUINT32, NN_DIGIT *, NEUINT32));

/* Generates an RSA key pair with a given length and public exponent.
 */
NEINT32 R_GeneratePEMKeys (publicKey, privateKey, protoKey, randomStruct)
...
R_RANDOM_STRUCT *randomStruct;                          /* random structure */
{
  NN_DIGIT d[MAX_NN_DIGITS], dP[MAX_NN_DIGITS], dQ[MAX_NN_DIGITS],
    ...
    v[MAX_NN_DIGITS];
  NEINT32 status;
  NEUINT32 nDigits, pBits, pDigits, qBits;
 ...
 */
static NEINT32 RSAFilter (a, aDigits, b, bDigits)
NN_DIGIT *a, *b;
NEUINT32 aDigits, bDigits;
{
  NEINT32 status;
 ...
 */
static NEINT32 RelativelyPrime (a, aDigits, b, bDigits)
NN_DIGIT *a, *b;
NEUINT32 aDigits, bDigits;
{
  NEINT32 status;
