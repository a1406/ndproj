...
/* Constants.
   ...
   Note: MAX_NN_DIGITS is NEINT32 enough to hold any RSA modulus, plus
...
#define DIGIT_MSB(x) (NEUINT32)(((x) >> (NN_DIGIT_BITS - 1)) & 1)
#define DIGIT_2MSB(x) (NEUINT32)(((x) >> (NN_DIGIT_BITS - 2)) & 3)
...
void NN_Decode PROTO_LIST
  ((NN_DIGIT *, NEUINT32, NEUINT8 *, NEUINT32));
void NN_Encode PROTO_LIST
  ((NEUINT8 *, NEUINT32, NN_DIGIT *, NEUINT32));

void NN_Assign PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NEUINT32));
void NN_AssignZero PROTO_LIST ((NN_DIGIT *, NEUINT32));
void NN_Assign2Exp PROTO_LIST ((NN_DIGIT *, NEUINT32, NEUINT32));

NN_DIGIT NN_Add PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32));
NN_DIGIT NN_Sub PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32));
void NN_Mult PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32));
void NN_Div PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32, NN_DIGIT *,
    NEUINT32));
NN_DIGIT NN_LShift PROTO_LIST 
  ((NN_DIGIT *, NN_DIGIT *, NEUINT32, NEUINT32));
NN_DIGIT NN_RShift PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NEUINT32, NEUINT32));

void NN_Mod PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NEUINT32, NN_DIGIT *, NEUINT32));
...
void NN_ModInv PROTO_LIST
  ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32));
void NN_Gcd PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NN_DIGIT *, NEUINT32));

NEINT32 NN_Cmp PROTO_LIST ((NN_DIGIT *, NN_DIGIT *, NEUINT32));
NEINT32 NN_Zero PROTO_LIST ((NN_DIGIT *, NEUINT32));
NEUINT32 NN_Bits PROTO_LIST ((NN_DIGIT *, NEUINT32));
NEUINT32 NN_Digits PROTO_LIST ((NN_DIGIT *, NEUINT32));
